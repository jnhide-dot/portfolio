...
const menuGroups=[
  ...
  {id:'portfolio',title:'문서',items:[spirit]},
...
main.innerHTML='<section class="showcase-hero"><div class="hero-panels">'+images.map((i,n)=>'<div class="hero-panel" style="--image-position:'+E(i.position||'50%')+'">'+imageTag(i,'',n===0)+'<span class="hero-game-name">'+E(i.title)+'</span></div>').join('')+'</div><div class="hero-heading"><p>JNHIDE / GAME DESIGN</p><h1>오타쿠의 상상이<br>현실로</h1><p class="hero-subtitle">전투 시스템·캐릭터 기획 · 어 식</p></div><div class="hero-bottom"><span>분석에서 기획으로</span><a href="#/projects">프로젝트 보기 <b>→</b></a><a href="#/playlist">플레이리스트 <b>→</b></a></div></section>'+profileSection()+'<section class="home-section"><div class="section-title"><div><p class="eyebrow">DOCUMENTS</p><h2>문서</h2></div><a href="#/portfolio">전체 보기 ↗</a></div>'+spiritCard()+'</section><section class="home-section"><div class="section-title"><div><p class="eyebrow">PROJECTS</p><h2>프로젝트 기록</h2></div><a href="#/projects">전체 보기 ↗</a></div>'+projects()+'</section><section class="playlist-banner"><div><p class="eyebrow">PLAYLIST</p><h2>플레이리스트</h2><p>'+playlist.length+'개의 게임, 플레이 기록과 전투 경험.</p><a class="solid-link" href="#/playlist">플레이리스트 보기 →</a></div><div class="playlist-name-wall">'+playlist.slice(0,12).map(g=>'<a href="#/games/'+g.id+'">'+E(g.title)+'</a>').join('')+'</div></section>';
}
function profileSection(){return '<section class="home-section home-profile" aria-labelledby="home-profile-title"><div class="section-title"><div><p class="eyebrow">ABOUT ME</p><h2 id="home-profile-title">프로필</h2></div></div><a class="profile-card" href="#/about"><div class="profile-identity"><span class="profile-handle">JNHIDE</span><h3>어 식</h3><p>전투 시스템 · 캐릭터 전투 기획</p></div><div class="profile-summary"><dl><div><dt>전공</dt><dd>컴퓨터공학</dd></div><div><dt>경험</dt><dd><ul class="profile-experience"><li>자연어 처리 학부연구생 · 1년</li><li><strong>매스 블리츠</strong><span>개인 프로젝트</span></li><li><strong>ProjectG</strong><span>첫 팀 프로젝트 · 캐릭터 전투 기획·서브 개발</span></li><li><strong>ProjectMD</strong><span>기업 협약 프로젝트 · PM·팀장·개발 총괄</span></li></ul></dd></div><div><dt>자격·어학</dt><dd>MOS Master · JLPT N3</dd></div></dl><span class="profile-view">프로필·연혁·사용 가능한 툴 보기 <span aria-hidden="true">↗</span></span></div></a></section>';}
function spiritCard(){return '<div class="project-grid"><a class="project-card" href="#/portfolio/spirit"><small>문서</small><h3>프로젝트 스피릿</h3><p>전투 분석 · 시스템 · 캐릭터</p><span class="view">문서 보기 →</span></a></div>';}
...
document.addEventListener('click',e=>{
 ...
 if(!pageMain.contains(a)&&!popup.contains(a))return;
